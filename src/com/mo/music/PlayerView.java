...
public class PlayerView extends Activity implements OnClickListener{
	...
	private void connectToNatureService(){		
		Intent intent = new Intent(PlayerView.this, MusicPlayService.class);				
	...
	class ProgressReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(MusicPlayService.ACTION_UPDATE_PROGRESS.equals(action)){
				int progress = intent.getIntExtra(MusicPlayService.ACTION_UPDATE_PROGRESS, currentPosition);				
				if(progress > 0){
				...
				int duration = intent.getIntExtra(MusicPlayService.ACTION_UPDATE_DURATION, 0);
