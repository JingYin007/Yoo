...
public class ChangeColor extends View
{
			...
			int defStyleAttr)
	{
		...
		for (int i = 0; i < n; i++)
		{
			...
			switch (attr)
			{
			case R.styleable.ChangeColor_icon:
				BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(attr);
				mIconBitmap = drawable.getBitmap();
				break;
			case R.styleable.ChangeColor_color:
				mColor = a.getColor(attr, 0xFF45C01A);
				break;
			case R.styleable.ChangeColor_text:
				mText = a.getString(attr);
				break;
			case R.styleable.ChangeColor_text_size:
